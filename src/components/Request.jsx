...
const Request = () => {
  return (
    ...
    <div className='flex flex-col justify-center items-center gap-5 text-white text-center bg-[#1CA6AF] w-screen py-10 px-6 h-auto ml-5 mr-5 lg:py-24 lg:px-24 lg:space-y-4 rounded-3xl'>
      ...
      <button className='bg-orange-400 text-white lg:text-lg py-4 px-8 font-bold rounded-full w-auto uppercase hover:bg-white hover:text-orange-400'>Get Started Today!</button>
    </div>
    </section>
  )
}
