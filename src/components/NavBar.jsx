        ...
        <nav className='flex justify-between lg:px-20 py-5'>
         ...
         {isMobileNav && <nav className='bg-[#ccf5ee] absolute top-0 w-[100%] mt-28 h-[400px] lg:hidden'>
           <ul className='capitalize flex flex-col gap-10 px-4 pt-12 text-base'>
            ...
            <Link to="/about"><li className=' text-[#32497dc4] cursor-pointer hover:text-[#f2a341]'>about us</li></Link>
            <Link to="/products"><li className=' text-[#32497dc4] cursor-pointer hover:text-[#f2a341]'>products</li></Link>
            <Link to="/marketplace"><li className=' text-[#32497dc4] cursor-pointer hover:text-[#f2a341]'>market place</li></Link>
            <Link to="/features"><li className=' text-[#32497dc4] cursor-pointer hover:text-[#f2a341]'>features</li></Link>
